(!(function (t, e) {
    ...
    var e = "SweetAlert2:",
        ...
        z = function (t) {
            ((t.style.opacity = ""),
                (t.style.display = t.id === I.content ? "block" : "flex"));
        },
        W = function (t) {
        ...
        tt = function (t) {
            var e = F(),
                ...
                o = L();
            if (
                (t.showConfirmButton || t.showCancelButton ? z(e) : W(e),
                t.showCancelButton ? (o.style.display = "inline-block") : W(o),
                t.showConfirmButton ? n.style.removeProperty("display") : W(n),
                ...
                (n.className = I.confirm),
                D(n, t.confirmButtonClass),
                t.customClass && D(n, t.customClass.confirmButton),
                (o.className = I.cancel),
                D(o, t.cancelButtonClass),
                t.customClass && D(o, t.customClass.cancelButton),
                t.buttonsStyling)
            ) {
                (D([n, o], I.styled),
        ...
        nt = function (t) {
            ...
            if (t.type)
                if (-1 !== Object.keys(f).indexOf(t.type)) {
                    var o = Et.getPopup().querySelector(
                        ".".concat(I.icon, ".").concat(f[t.type]),
                    );
                    (z(o),
                        t.customClass && D(o, t.customClass.icon),
                        t.animation &&
                            D(o, "swal2-animate-".concat(t.type, "-icon")));
                } else
                    H(
        ...
        ot = function (t) {
            ...
            t.imageUrl
                ? (e.setAttribute("src", t.imageUrl),
                  ...
                  (e.className = I.image),
                  t.imageClass && D(e, t.imageClass),
                  t.customClass && D(e, t.customClass.image))
                : W(e);
        },
        it = function (i) {
            var r = A(),
                ...
                ? (z(r),
                  ...
                  i.progressSteps.forEach(function (t, e) {
                      ...
                      if (
                          (D(n, I["progress-step"]),
                          (n.innerHTML = t),
                          e === a && D(n, I["active-progress-step"]),
                          r.appendChild(n),
                          e !== i.progressSteps.length - 1)
                      ) {
                          var o = document.createElement("li");
                          (D(o, I["progress-step-line"]),
    ...
    function ht() {
        ...
        (t.showConfirmButton ||
            (W(e.confirmButton), t.showCancelButton || W(e.actions)),
            U([e.popup, e.actions], I.loading),
    ...
    function Ct(t) {
        ...
        if (n) {
                ...
                (T()
                    ...
                    : (new Promise(function (t) {
                          ...
                          ((ct.restoreFocusTimeout = setTimeout(function () {
                              ...
                              ct.previousActiveElement.focus
                                  ? (ct.previousActiveElement.focus(),
                                    (ct.previousActiveElement = null))
                      ...
                      ct.keydownTarget.removeEventListener(
                          "keydown",
                          ct.keydownHandler,
            ...
            (G && !g(n, I.noanimation)
                ? n.addEventListener(G, function t() {
    ...
    var At = function (t) {
        ...
        (null !== t.onBeforeOpen &&
            ...
            t.onBeforeOpen(n),
            t.animation
                ? (D(n, I.show), D(e, I.fade), U(n, I.hide))
                : U(n, I.fade),
            z(n),
            (e.style.overflowY = "hidden"),
            G && !g(n, I.noanimation)
                ? n.addEventListener(G, function t() {
                      (n.removeEventListener(G, t),
                          (e.style.overflowY = "auto"));
                  })
                : (e.style.overflowY = "auto"),
            D([document.documentElement, document.body, e], I.shown),
            t.heightAuto &&
                t.backdrop &&
                !t.toast &&
                D([document.documentElement, document.body], I["height-auto"]),
            E() &&
                (t.scrollbarPadding && vt(),
                (function () {
                    if (
                ...
                "undefined" != typeof window &&
                    bt() &&
                    (yt(), window.addEventListener("resize", yt)),
                p(document.body.children).forEach(function (t) {
                    t === v() ||
                        (function (t, e) {
    ...
    var Pt,
        St = Object.freeze({
                ...
                switch (t) {
                    ...
                    case "checkbox":
                        return n.popup.querySelector(
                            ".".concat(I.checkbox, " input"),
                        );
                    case "radio":
                        return (
                            n.popup.querySelector(
                                ".".concat(I.radio, " input:checked"),
                            ) ||
                            n.popup.querySelector(
            ...
            _main: function (t) {
                ...
                !(function (t) {
                    for (var e in t)
                        (pt(e) || q('Unknown parameter "'.concat(e, '"')),
                            t.toast &&
                                -1 !== dt.indexOf(e) &&
                                q(
                ...
                (!(function (e) {
                    ...
                    (e.showCloseButton
                        ? (c.setAttribute("aria-label", e.closeButtonAriaLabel),
                          z(c))
                        : W(c),
                        (t.className = I.popup),
                        e.toast
                        ...
                        e.customClass &&
                            ...
                            D(u, e.customClass.header),
                            D(l, e.customClass.title),
                            D(c, e.customClass.closeButton),
                            D(d, e.customClass.content),
                            D(p, e.customClass.actions),
                            D(f, e.customClass.footer)),
                        e.customContainerClass && D(s, e.customContainerClass),
                        it(e),
                        nt(e),
                        ot(e),
                        tt(e),
                ...
                return new Promise(function (t) {
                    ...
                    (wt.swalPromiseResolve.set(E, t),
                        T.timer &&
                            (ct.timeout = new Bt(function () {
                    ...
                    for (
                        var c = function (e) {
                                (T.showLoaderOnConfirm && M.showLoading(),
                                    T.preConfirm
                                ...
                                switch (t.type) {
                                    case "click":
                                        if (i)
                                            ...
                                            r &&
                                                (E.disableButtons(),
                                                s(M.DismissReason.cancel));
                                }
                            },
                            o = O.popup.querySelectorAll("button"),
                            i = 0;
                        i < o.length;
                        i++
                    )
                            ...
                            (O.container.onclick = function (t) {
                                r
                                    ...
                                    : t.target === O.container &&
                                      j(T.allowOutsideClick) &&
                                      s(M.DismissReason.backdrop);
                            }));
                    }
                    T.reverseButtons
                        ? O.confirmButton.parentNode.insertBefore(
                              O.cancelButton,
                              O.confirmButton,
                          )
                        : O.confirmButton.parentNode.insertBefore(
                    ...
                    (ct.keydownHandlerAdded &&
                        ...
                        T.toast ||
                                        ...
                                        if ("Tab" === t.key) {
                                            ...
                                            [
                                                ...
                                                ? document.activeElement ===
                                                      O.confirmButton &&
                                                  K(O.cancelButton)
                                                    ? O.cancelButton.focus()
                                                    : document.activeElement ===
                                                          O.cancelButton &&
                                                      K(O.confirmButton) &&
                                                      O.confirmButton.focus()
                                                : ("Escape" !== t.key &&
                                                      "Esc" !== t.key) ||
                                                  !0 !== j(e.allowEscapeKey) ||
                                                  (t.preventDefault(),
                                                  s(M.DismissReason.esc));
                                    else if (
                                        t.target &&
                                        E.getInput() &&
                                        t.target.outerHTML ===
                                            E.getInput().outerHTML
                                    ) {
                                        if (
                                            -1 !==
                            ...
                            (ct.keydownTarget = T.keydownListenerCapture
                                ? window
                                : O.popup),
                            (ct.keydownListenerCapture =
                    ...
                    for (
                        var u,
                            ...
                            p = function (t) {
                                (t.placeholder && !T.inputPlaceholder) ||
                                    (t.placeholder = T.inputPlaceholder);
                            },
                            f = 0;
                        f < d.length;
                        ...
                        if ((u = E.getInput(d[f]))) {
                            ...
                            for (var b in T.inputAttributes)
                                ("range" === d[f] && "placeholder" === b) ||
                                    u.setAttribute(b, T.inputAttributes[b]);
                        }
                        ((g.className = m),
                            T.inputClass && D(g, T.inputClass),
                            T.customClass && D(g, T.customClass.input),
                            W(g));
                    }
                    switch (T.input) {
                        case "text":
                        ...
                        case "select":
                            ...
                            if (((k.innerHTML = ""), T.inputPlaceholder)) {
                                ...
                                ((B.innerHTML = T.inputPlaceholder),
                                    (B.value = ""),
                                    (B.disabled = !0),
                                    (B.selected = !0),
                                    k.appendChild(B));
                            ...
                            l = function (t) {
                                (t.forEach(function (t) {
                                    ...
                                    ((o.value = e),
                                        (o.innerHTML = n),
                                        T.inputValue.toString() ===
                                            e.toString() && (o.selected = !0),
                                        k.appendChild(o));
                                }),
                                    z(k),
                                    k.focus());
                        ...
                        case "checkbox":
                            ...
                            ((P.type = "checkbox"),
                                (P.value = 1),
                                (P.id = I.checkbox),
                                (P.checked = Boolean(T.inputValue)),
                    ...
                    (At(T),
                        T.toast ||
                            (j(T.allowEnterKey)
                                ? T.focusCancel && K(O.cancelButton)
                                    ? O.cancelButton.focus()
                                    : T.focusConfirm && K(O.confirmButton)
                                      ? O.confirmButton.focus()
                                      : a(-1, 1)
                                : document.activeElement &&
                                  "function" ==
