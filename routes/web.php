...
})->middleware(['auth', 'verified', 'check.status', 'can:dashboard.permission'])->name('dashboard');
...
Route::middleware(['auth', 'can:permission.permission', 'check.status'])->group(function () {
...
Route::middleware(['auth', 'can:role.permission', 'check.status'])->group(function () {
...
Route::middleware(['auth', 'can:user.permission', 'check.status'])->group(function () {
...
Route::middleware(['auth', 'can:category.permission', 'check.status'])->group(function () {
    Route::get('/categories', [CategoryController::class, 'index'])->name('categories.index')->middleware('can:category.list');
    Route::get('/categories/create', [CategoryController::class, 'create'])->name('categories.create')->middleware('can:category.create');
    Route::post('/categories/store', [CategoryController::class, 'store'])->name('categories.store')->middleware('can:category.create');
    Route::get('/categories/edit/{id}', [CategoryController::class, 'edit'])->name('categories.edit')->middleware('can:category.edit');
    Route::put('/categories/update/{id}', [CategoryController::class, 'update'])->name('categories.update')->middleware('can:category.edit');
    Route::delete('/categories/delete/{id}', [CategoryController::class, 'destroy'])->name('categories.delete')->middleware('can:category.delete');
});

Route::middleware(['auth', 'can:activity-log.permission', 'check.status'])->group(function () {
