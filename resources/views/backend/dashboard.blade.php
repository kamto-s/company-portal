        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <i class="float-right m-0 bx bx-layer h2 text-muted"></i>
                            <h6 class="mt-0 text-muted text-uppercase">Orders</h6>
                            <h3 class="mb-3" data-plugin="counterup">1,587</h3>
                            <span class="mr-1 badge badge-success"> +11% </span> <span class="text-muted">From
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <i class="float-right m-0 bx bx-dollar-circle h2 text-muted"></i>
                            <h6 class="mt-0 text-muted text-uppercase">Revenue</h6>
                            <h3 class="mb-3">$<span data-plugin="counterup">46,782</span></h3>
                            <span class="mr-1 badge badge-danger"> -29% </span> <span class="text-muted">From
                                previous period</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <i class="float-right m-0 bx bx-bx bx-analyse h2 text-muted"></i>
                            <h6 class="mt-0 text-muted text-uppercase">Average Price</h6>
                            <h3 class="mb-3">$<span data-plugin="counterup">15.9</span></h3>
                            <span class="mr-1 badge badge-warning"> 0% </span> <span class="text-muted">From
                                previous period</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <i class="float-right m-0 bx bx-basket h2 text-muted"></i>
                            <h6 class="mt-0 text-muted text-uppercase">Product Sold</h6>
                            <h3 class="mb-3" data-plugin="counterup">1,890</h3>
                            <span class="mr-1 badge badge-success"> +89% </span> <span class="text-muted">Last
                                year</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="float-right dropdown position-relative">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center row">
                                ...
                                <div class="col-6">
                                    <h4>541</h4>
                                    <p class="mb-0 text-muted">Total Offers</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="overflow-hidden card-title">Recent Buyers</h4>
                            <p class="mb-4 overflow-hidden card-subtitle font-size-13">Transaction period from
                                21 July to 25 Aug
                            </p>

                            <div class="table-responsive">
                                <table class="table mb-0 table-centered table-hover table-xl" id="recent-orders">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="p-2 badge badge-soft-success">Mobile</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="p-2 badge badge-soft-success">Tablet</span>
                                            </td>
                                            <td>
                                                <div class="progress" style="height: 6px;">
                                                    <div class="progress-bar progress-bar-striped bg-secondary"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="p-2 badge badge-soft-success">Electronics</span>
                                            </td>
                                            <td>
                                                <div class="progress" style="height: 6px;">
                                                    <div class="progress-bar progress-bar-striped bg-secondary"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="p-2 badge badge-soft-success">Cosmetics</span>
                                            </td>
                                            <td>
                                                <div class="progress" style="height: 6px;">
                                                    <div class="progress-bar progress-bar-striped bg-secondary"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="p-2 badge badge-soft-success">Appliences</span>
                                            </td>
                                            <td>
                                                <div class="progress" style="height: 6px;">
                                                    <div class="progress-bar progress-bar-striped bg-secondary"
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="overflow-hidden card-title">Account Transactions</h4>
                            <p class="mb-4 overflow-hidden card-subtitle font-size-13">Transaction period from
                                21 July to 25 Aug
                            </p>

                            <div class="table-responsive">
                                <table class="table mb-0 table-borderless table-hover table-centered table-nowrap">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">4257 **** ****
                                                    7852</h5>
                                                <span class="text-muted font-size-12">11 April 2019</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">$79.49</h5>
                                                <span class="text-muted font-size-12">Amount</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-17 font-weight-normal"><i
                                                        class="fab fa-cc-visa"></i></h5>
                                                <span class="text-muted font-size-12">Card</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">Helen Warren
                                                </h5>
                                        ...
                                        <tr>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">4265 **** ****
                                                    0025</h5>
                                                <span class="text-muted font-size-12">28 Jan 2019</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">$1254.00</h5>
                                                <span class="text-muted font-size-12">Amount</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-17 font-weight-normal"><i
                                            ...
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">Kayla Lambie
                                                </h5>
                                                <span class="text-muted font-size-12">Pay</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">5570 **** ****
                                                    8547</h5>
                                                <span class="text-muted font-size-12">08 Dec 2018</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">$784.25</h5>
                                                <span class="text-muted font-size-12">Amount</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-17 font-weight-normal"><i
                                            ...
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">Hugo Lavarack
                                                </h5>
                                                <span class="text-muted font-size-12">Pay</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">7845 **** ****
                                                    5214</h5>
                                                <span class="text-muted font-size-12">03 Dec 2018</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">$485.24</h5>
                                                <span class="text-muted font-size-12">Amount</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-17 font-weight-normal"><i
                                            ...
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">Amber Scurry
                                                </h5>
                                                <span class="text-muted font-size-12">Pay</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">$8964.04</h5>
                                                <span class="text-muted font-size-12">Amount</span>
                                            </td>
                                            <td>
                                                <h5 class="mb-1 font-size-17 font-weight-normal"><i
                                            ...
                                            <td>
                                                <h5 class="mb-1 font-size-15 font-weight-normal">Caitlyn Gibney
                                                </h5>
                                                <span class="text-muted font-size-12">Pay</span>
                                            </td>
                                        </tr>
