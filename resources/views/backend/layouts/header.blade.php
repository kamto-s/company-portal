        <header id="page-topbar">
            <div class="navbar-header">
                ...
                <div class="d-flex align-items-left">
                    <button type="button" class="px-3 mr-2 btn btn-sm d-lg-none font-size-16 header-item waves-effect"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-2 dropdown d-none d-sm-inline-block">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="p-0 dropdown-menu dropdown-menu-lg dropdown-menu-right"
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="mb-1 font-size-13">You have new follower on Instagram</p>
                                            <p class="mb-0 font-size-12 text-muted"><i
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="mb-1 font-size-13">Latest version of admin is now available.
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="mb-1 font-size-13">Just upgraded to premium account.</p>
                                            <p class="mb-0 font-size-12 text-muted"><i
                            ...
                            <div class="p-2 border-top">
                                <a class="text-center btn btn-sm btn-light btn-block" href="javascript:void(0)">
                                    <i class="mr-1 mdi mdi-arrow-down-circle"></i> Load More..
                                </a>
                            </div>
                        </div>
                    </div>
